...
//                            .enableSwagger() // 开启 swagger 模式
//                            .fileOverride() // 覆盖已生成文件
                            .outputDir("/Users/chenylnti/codefile/back/yhr/yhr-system/src/main/java"); // 指定输出目录
                })
                .dataSourceConfig(builder -> builder.typeConvertHandler((globalConfig, typeRegistry, metaInfo) -> {
                    int typeCode = metaInfo.getJdbcType().TYPE_CODE;
                    if (typeCode == Types.SMALLINT) {
                ...
                .packageConfig(builder -> {
                    builder.parent("io.chenylnti.yhr") // 设置父包名
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "/Users/chenylnti/codefile/back/yhr/yhr-system/src/main/resources/mapper")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
...
//                            .enableSwagger() // 开启 swagger 模式
//                            .fileOverride() // 覆盖已生成文件
                            .outputDir("/Users/chenylnti/codefile/back/yhr/yhr-employee/src/main/java"); // 指定输出目录
                })
                .dataSourceConfig(builder -> builder.typeConvertHandler((globalConfig, typeRegistry, metaInfo) -> {
                    int typeCode = metaInfo.getJdbcType().TYPE_CODE;
                    if (typeCode == Types.SMALLINT) {
                ...
                .packageConfig(builder -> {
                    builder.parent("io.chenylnti.yhr") // 设置父包名
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "/Users/chenylnti/codefile/back/yhr/yhr-employee/src/main/resources/mapper")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.addInclude("employee","empsalary","employeetrain","employeeremove","salary","nation","politicsstatus","joblevel","position") // 设置需要生成的表名
                            .addTablePrefix("t_", "c_"); // 设置过滤表前缀
                })
                .templateEngine(new FreemarkerTemplateEngine()) // 使用Freemarker引擎模板，默认的是Velocity引擎模板
                .execute();
